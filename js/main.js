...
(function($) {
    ...
    // Popup for the fourth product
    if ($('a[href="#product-choose-4"]').length) {
        $('a[href="#product-choose-4"]').magnificPopup({
            type: 'inline',
            mainClass: 'mfp-fade',
            midClick: true
        });
