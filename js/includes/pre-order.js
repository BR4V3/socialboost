...
$(function() {
   ...
   ================================================ */
    ...
    $("#preorderform-2").submit(function(e) {
        e.preventDefault();
    }).validate({
        rules: {},
        submitHandler: function(form) {
            ...
            var redirect = $('#preorderform-2').data('redirect');
            var noredirect = false;
            if (redirect == 'none' || redirect == "" || redirect == null) {
                noredirect = true;
            }
    ...
    $("#preorderform-3").submit(function(e) {
        e.preventDefault();
    }).validate({
        rules: {},
        submitHandler: function(form) {
            ...
            var redirect = $('#preorderform-3').data('redirect');
            var noredirect = false;
            if (redirect == 'none' || redirect == "" || redirect == null) {
                noredirect = true;
            }
    ...
    $("#preorderform-4").submit(function(e) {
        e.preventDefault();
    }).validate({
        rules: {},
        submitHandler: function(form) {
            ...
            var redirect = $('#preorderform-4').data('redirect');
            var noredirect = false;
            if (redirect == 'none' || redirect == "" || redirect == null) {
                noredirect = true;
            }
