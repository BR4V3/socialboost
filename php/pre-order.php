...
$to    = "Ramirezvega.benjamin@gmail.com"; // <--- Your email ID here
...
if (isset($email) && isset($name)) {
	...
	$subject  = "Nueva Pre-Orden de : $name"; // <--- Contact for Subject here.
 
	$msg      = 'Hola Administrador, <br/> <br/> Aqui estan los detalles sobre una pre-compra:';
	...
	$msg      .= " </table> <br> --- <br>Este mail fue enviado desde: $website";
